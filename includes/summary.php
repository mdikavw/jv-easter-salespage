        ...
        <div class="col-lg-6">
            <div class="card bg-success mb-3 h-100 p-2">
                <div class="card-body">
                    ...
                    <p class="card-text">
                        Our Easter-themed coloring books are perfect for entertaining
                        both kids and adults. With intricate designs and delightful
                        themes, these coloring books are sure to keep your audience
        ...
        <div class="col-lg-6">
            <div class="card bg-success mb-3 h-100 p-2">
                <div class="card-body">
                    ...
                    <p class="card-text">
                        Captivate your audience with our Easter quotes. From heartfelt
                        messages to funny quips, our collection of quotes is perfect for
                        social media posts, blog articles, or as captions for your
                        images.
                    </p>
                </div>
            </div>
        ...
        <div class="col-lg-6">
            <div class="card bg-success mb-3 h-100 p-2">
                <div class="card-body">
                    ...
                    <p class="card-text">
                        Don't have time to create your own content? Let our team of
                        experts craft compelling Easter-themed posts for you. We'll help
                        you connect with your audience and showcase your brand in a
        ...
        <div class="col-lg-6">
            <div class="card bg-success mb-3 h-100 p-2">
                <div class="card-body">
                    ...
                    <ul>
                        <li class="card-text">
                            Premium Quality: Our products are crafted with care and
                            attention to detail.
                        </li>
                        <li class="card-text">
                            Easy to Use: Our products are user-friendly, allowing you to
                            create stunning content effortlessly.
                        </li>
                        <li class="card-text">
                            Affordable Pricing: We offer competitive pricing so you can
